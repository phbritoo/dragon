...
export const saveDragon = (dragonDetails) => {
    return dispatch => {
        ...
        axios.put(url, dragonDetails)
            ...
            .catch(error => {    
                dispatch(saveDragonFail("Sorry! Ocorreu um erro ao salvar o dragão :("));
            })
    }
}
...
export const deleteDragon = dragonId => {
    return dispatch => {
        ...
        axios.delete(url)
            ...
            .catch( error => {
                dispatch(deleteDragonFail("Sorry! Ocorreu um erro ao excluir o dragão :("))
            })
    }
}
...
export const createDragon = (newDragon) => {
    return dispatch => {
        ...
        axios.post(url,newDragon)
            ...
            .catch(error => {
                dispatch(createDragonFail("Sorry! Ocorreu um erro ao criar um dragão :("));
            })
